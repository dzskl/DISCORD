...
function getMasterKey() {
  ...
  try {
    ...
    require('../utils/logger').warn({ file: KEY_FILE }, 'chave de criptografia gerada — faca backup!');
    return masterKey;
  }
}
...
function decrypt(blob) {
  ...
  try {
    ...
    require('../utils/logger').error({ err: e.message }, 'falha ao decriptar credencial');
    return null;
  }
}
